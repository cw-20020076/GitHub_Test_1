    ...
    flexButtonCallback(this, &Screen6ViewBase::flexButtonCallbackHandler)
{
    ...
    image1.setXY(0, 0);
    image1.setBitmap(touchgfx::Bitmap(BITMAP_TWINCOOKER06_ID));

    flexButton1.setBoxWithBorderPosition(0, 0, 82, 32);
    flexButton1.setBorderSize(5);
    flexButton1.setBoxWithBorderColors(touchgfx::Color::getColorFromRGB(0, 102, 153), touchgfx::Color::getColorFromRGB(0, 153, 204), touchgfx::Color::getColorFromRGB(0, 51, 102), touchgfx::Color::getColorFromRGB(51, 102, 153));
    flexButton1.setPosition(270, 20, 82, 32);
...
void Screen6ViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    ...
    {
        //Interaction1
        //When flexButton1 clicked change screen to Screen7
    ...
    {
        //Interaction2
        //When flexButton2 clicked change screen to Screen5_2
